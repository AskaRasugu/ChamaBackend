...
const typeDefs = `#graphql
 ...
 type UserAccounts {
  ...
  type Query {
    ...
    allBlogs(limit: Int, offset: Int): [Blog!]
    activeBlogs(limit: Int, offset: Int): [Blog!]
    usersBlogs( limit: Int, offset: Int): [Blog!]
    oneBlog(blogId: ID!): Blog!
    allComments(limit: Int, offset: Int): [Comments!]
    usersComments( user: ID! limit: Int, offset: Int): [Comments!]
    blogsComments( blogId: ID! limit: Int, offset: Int): [Comments!]
    oneComment(commentId: ID!): Comments!
  ...
  type Mutation {
    ...
    createABlog(createblog: createBlog): Blog!
    updateABlog(input:updateBlog): Blog!
    deleteABlog(blogId: ID!): Blog!
    createAComment(createcomment:createComment): Comments!
    updateAComment(input:updatecomment): Comments!
    deleteAComment(commentId: ID!): Comments!
