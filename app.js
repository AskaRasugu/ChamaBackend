...
async function startApolloServer(typeDefs, resolvers) {
  ...
  mongoose
    .connect(
      `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_ATLAS_PW}@${process.env.mongodb_clustername}.6ukhhri.mongodb.net/${process.env.MONGO_DB}?retryWrites=true&w=majority`,
